...
namespace SyncPOS
{
    ...
    public class SyncCatalogos : ISyncCatalogos
    {
        ...
        {
            using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
            {
                if (lastChangeDateTime.Equals((object)DateTime.Parse("01/01/2017 07:00:00")))
                    return PosAdminDataContext.unidad_medida.Select<unidad_medida, SyncPOS.domain.unidad_medida>((Expression<Func<unidad_medida, SyncPOS.domain.unidad_medida>>)(e => new SyncPOS.domain.unidad_medida()
                    {
                        id_unidad = e.id_unidad,
                        descripcion = e.descripcion,
                        fecha_registro = DateTime.Now
                    })).ToList<SyncPOS.domain.unidad_medida>();
                return PosAdminDataContext.unidad_medida.Where<unidad_medida>((Expression<Func<unidad_medida, bool>>)(e => e.fecha_registro > DateTime.Parse(lastChangeDateTime))).Select<unidad_medida, SyncPOS.domain.unidad_medida>((Expression<Func<unidad_medida, SyncPOS.domain.unidad_medida>>)(e => new SyncPOS.domain.unidad_medida()
                {
                    id_unidad = e.id_unidad,
                    descripcion = e.descripcion,
        ...
        {
            using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                return PosAdminDataContext.proveedor.Where<proveedor>((Expression<Func<proveedor, bool>>)(a => a.fecha_registro > DateTime.Parse(lastChangeDateTime))).Select<proveedor, SyncPOS.domain.proveedor>((Expression<Func<proveedor, SyncPOS.domain.proveedor>>)(e => new SyncPOS.domain.proveedor()
                {
        ...
        public List<SyncPOS.domain.usuario> getUsuarios(string lastChangeDateTime)
        {
            ...
            {
                if (lastChangeDateTime.Equals((object)DateTime.Parse("01/01/2017 07:00:00")))
                    return PosAdminDataContext.usuario.Select<usuario, SyncPOS.domain.usuario>((Expression<Func<usuario, SyncPOS.domain.usuario>>)(e => new SyncPOS.domain.usuario()
                    {
                ...
                return PosAdminDataContext.usuario.Where<usuario>((Expression<Func<usuario, bool>>)(u => u.fecha_registro > DateTime.Parse(lastChangeDateTime))).Select<usuario, SyncPOS.domain.usuario>((Expression<Func<usuario, SyncPOS.domain.usuario>>)(u => new SyncPOS.domain.usuario()
                {
        ...
        public List<SyncPOS.domain.usuario_permiso> getPermisosUsuarios(string lastChangeDateTime)
        {
            ...
            {
                if (lastChangeDateTime.Equals((object)DateTime.Parse("01/01/2017 07:00:00")))
                    return PosAdminDataContext.usuario_permiso.Select<usuario_permiso, SyncPOS.domain.usuario_permiso>((Expression<Func<usuario_permiso, SyncPOS.domain.usuario_permiso>>)(u => new SyncPOS.domain.usuario_permiso()
                    {
                        user_name = u.user_name,
                ...
                return PosAdminDataContext.usuario_permiso.Where<usuario_permiso>((Expression<Func<usuario_permiso, bool>>)(up => up.fecha_registro > DateTime.Parse(lastChangeDateTime))).Select<usuario_permiso, SyncPOS.domain.usuario_permiso>((Expression<Func<usuario_permiso, SyncPOS.domain.usuario_permiso>>)(up => new SyncPOS.domain.usuario_permiso()
                {
        ...
        public List<SyncPOS.domain.pedido> GetOrders(string lastChangeDateTime)
        {
            using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                return PosAdminDataContext.orden
                    .Where<orden>((Expression<Func<orden, bool>>)(a => a.fecha_registro > DateTime.Parse(lastChangeDateTime)))
                    .Select<orden, SyncPOS.domain.pedido>((Expression<Func<orden, SyncPOS.domain.pedido>>)(a => new SyncPOS.domain.pedido()
                    {
                        ...
                        fecha_registro = a.fecha_registro
                    })).ToList<SyncPOS.domain.pedido>();
        }

        public List<SyncPOS.domain.pedido_articulo> GetOrderDetail(Guid id_pedido)
        {
            using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                return PosAdminDataContext.orden_articulo
                    .Where<orden_articulo>((Expression<Func<orden_articulo, bool>>)(a => a.id_pedido.Equals(id_pedido)))
                    .Select<orden_articulo, SyncPOS.domain.pedido_articulo>((Expression<Func<orden_articulo, SyncPOS.domain.pedido_articulo>>)(a => new SyncPOS.domain.pedido_articulo()
                    {
                        id_pedido = a.id_pedido,
                        ...
                        fecha_registro = a.fecha_registro
                    })).ToList<SyncPOS.domain.pedido_articulo>();
        }

        public List<SyncPOS.domain.pedido_articulo> GetOrderDetailUpdate(string lastChangeDateTime)
        {
            using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                return PosAdminDataContext.orden_articulo
                    .Where<orden_articulo>((Expression<Func<orden_articulo, bool>>)(a => a.fecha_registro > DateTime.Parse(lastChangeDateTime)))
                    .Select<orden_articulo, SyncPOS.domain.pedido_articulo>((Expression<Func<orden_articulo, SyncPOS.domain.pedido_articulo>>)(a => new SyncPOS.domain.pedido_articulo()
                    {
                        id_pedido = a.id_pedido,
                        no_articulo = a.no_articulo,
        ...
        public bool SetInventarios(SyncPOS.domain.inventario_captura p)
        {
            try
            {
                using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                {
                    if (PosAdminDataContext.inventario_captura.FirstOrDefault<inventario_captura>((Expression<Func<inventario_captura, bool>>)(e => e.id_inventario_fisico.Equals(new Guid(p.id_inventario_fisico)) && e.num_captura.Equals(long.Parse(p.num_captura)) && e.cod_barras.Equals(p.cod_barras))) == null)
                    {
                        ...
                        PosAdminDataContext.inventario_captura.InsertOnSubmit(entity);
                        PosAdminDataContext.SubmitChanges();
                    }
                }
                return true;
            }
        ...
        public bool CreatePurchase(SyncPOS.domain.compra p)
        {
            try
            {
                using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                {
                    if (PosAdminDataContext.compra.FirstOrDefault<compra>((Expression<Func<compra, bool>>)(c => c.id_compra.Equals(p.id_compra))) == null)
                    {
                        PosAdminDataContext.compra.InsertOnSubmit(new compra()
                        {
        ...
        public bool CreatePurchaseDetail(SyncPOS.domain.compra_articulo p)
        {
            try
            {
                using (PosAdminDataContext PosAdminDataContext = new PosAdminDataContext())
                {
                    if (PosAdminDataContext.compra_articulo.FirstOrDefault<compra_articulo>((Expression<Func<compra_articulo, bool>>)(c => c.id_compra.Equals(p.id_compra) && c.cod_barras.Equals(p.cod_barras) && c.num_articulo.Equals(p.num_articulo))) == null)
                    {
                        PosAdminDataContext.compra_articulo.InsertOnSubmit(new compra_articulo()
                        {
                            id_compra = Guid.Parse(p.id_compra),
                            cod_barras = p.cod_barras,
